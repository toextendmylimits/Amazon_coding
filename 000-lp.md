...
1. Rebuild orderbook application.  
   Questions: Most difficult project you worked on?
    ...
    Then I did an investigation into the technologies and came up with a design that utilized micro service architecture and springboot framework to improve productivity and increase scalibility. I also
    ...
    Result:  
    Eventually the project finished successfully within the scheduled time. Although the code change was enormous, the appliation had very few issues since it went live. And The new functionalities were well received by the clients and as a result the revenue incrased by 10%. 
