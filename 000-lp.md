...
Result:
Finally the person agreed with changed the code accordingly. And the presentation I gave to people were well received and they were happy to follow the principles of clean code. A month later, we reviewed the code commits from various teams and found that the code quality improved significantly, with code formatting issues decreased by 50%. 
