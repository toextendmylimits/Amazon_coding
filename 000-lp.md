...
1. Project delay
   Situation:
   During a project, I underestimated the complexity of developing a custom module for our software application. As the technical lead, I was responsible for overseeing the module’s development and integration. Initially, I underestimated the time and resources required for the module development. As a result, we encountered delays and difficulties in meeting the project’s timeline.

   Action:
   To handle the situation, I immediately communicated the issue to the project team and stakeholders, taking responsibility for the underestimation. I reassessed the requirements, collaborated with developers to identify bottlenecks, and created a detailed plan with realistic timelines.

   Result:
   Through proactive communication and reevaluation, we successfully addressed the challenges and completed the module within an adjusted timeline. This experience taught me the importance of thorough estimation and involving the development team in the planning process to avoid underestimating technical tasks in the future.
...
1. Example 2
   Sitution:  
   When I worked on a new functionality to save trades that a user did for the day and redisplay when the traded re-logged in. The funcationality invovled both the front-end and back-end change and I was mainly responsible for working on the back-end change. Our main front-end stuff was done by front-end developers but back then two front-end developers just left so we didn't have enough front-end developers. So instead of waiting until the other front-end developers had capacity, I decided to learn the front end technologies and worked on the front-end as well.

   Task:
   The main technologies used by the front end framework was AngularJS, which had a quite steep learning curve.
   ...
   Then looked at the documenation for our front end framework, and tried to have a high level understanding of how things worked. 
