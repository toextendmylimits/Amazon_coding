...
1. Missed a deadline
Situation:
I remember I once missed a deadline. Early days in my career, I worked extremely hard and was often overly eager to go to the extra mile. Then I was asked to lead a small team to work on a feature for one of our clients. It was my first time leading a project, so I was very keen to please the client. They had high expectations and the deadline was  tight. However, on top of that, I completely miscalculated the time needed to complete the project. I also failed to predict different complexities along the way. Although the team worked hard, soon it became very clear that the project couldn't be finished within the deadline.

Task:
So the challeage was how to really finish the project.

Actions:
Firstly, I had a meeting with the team and discussed a realistic delivery timeframe.  I did a root cause analysis with the team and identified bottlenecks by reviewing the project timeline and checking the main dependencies. I then asked the team to give some very realistic estimates to the remaining tasks together, considering the unforseen contigency as well. I also asked each person to voice their concerns or issues. Then I came up with a new timeframe to finish the project, which turned out to be a few weeks longer than the original one.

Secondly I communicated to the client candidly and admitted it was my mistake in underestimating the tasks, and asked the client to approve the new deadline. The client was not very happy with the delay, but showed understanding of the situation, and approved it. 

Result:
Finally the project was finished with the new proposed date, which was a few weeks than the orignal one.  The situation was not ideal but it helped me improve my planning skills and distribute tasks in a more efficient way, and this experience also taught me just how crucial it was to collborate well with the team and communicate openly . Luckily, I learned from my mistake and it never happened again.
