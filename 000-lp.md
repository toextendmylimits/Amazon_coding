...
1. Missed a deadline
   Situation:  
   I recall I once missed a deadline during early days of my career. Back then, I worked extremely hard and was often overly eager to go to the extra mile. Then I was asked to lead a small team to work on a feature for one of our clients. It was my first time leading a project, so I was very keen to  prove myself. The client had high very expectations. However, I neglected that and set a very unrealistic deadline to please the client without even consulting other team members. On top of that, I completely miscalculated the time needed to complete the project. I also failed to predict different complexities along the way. Although I pushed the team really hard, soon it became very clear that the project couldn't be finished within the deadline.
   ...
   Secondly I communicated to the client openly, expressed the situation, apologized for the project dealy, and admited now the project couldn't be finished within the deadline, and asked the client to approve the new deadline. The client was not very happy with the delay, but showed understanding of the situation, and agreed with the project deadline. 
