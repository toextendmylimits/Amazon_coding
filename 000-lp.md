...
1. [Have Backbone; Disagree & Commit; Disagree and commit](#have-backbone-disagree--commit-disagree-and-commit):  
...
1. [Insist on highest standards](#insist-on-highest-standards):    
Questions: Described a time you refuse to compromise on the standards? What was the result?   
   Tell me about a time you had to make a decision to make short-term sacrifices for long-term gains.    
[Insist on writing clean code ](#insist-on-writing-clean-code)   
[Insist that developers to do thorough testing](#insist-that-developers-to-do-thorough-testing)   

1. [Invent and simplify](#invent-and-simplify):  
Questions: Please tell me about a time you make a simple solution to a complex issue, follow up: Why is that complex, how you find out the solution, and why do you think your solution/implementation can benefit your client?  
[Invent an effective way for database migration](#invent-an-effective-way-for-database-migration)  
[Simplified release process](#simplified-release-process)  

1. [Bias for action]  
Questions: A time where you’ve taken a calculated risk where speed was crucial? What was the situation? How did you handle it? What steps did you take to mitigate the risk? What was the outcome? Knowing what you know now, would you do something differently?  
[Made a functionality work differently to what clients used to](#made-a-functionality-work-differently-to-what-clients-used-to)  
[Released fix to production issue although there was risk](#released-fix-to-production-issue-although-there-was-risk)  (This could be used potentially for dive deep)

1. [Are right a lot about decisions](#are-right-a-lot-decisions)
Questions: Tell me about a time that you have to make a decision between standard and delivery?

1. [Failures](#failures)  
[Missed a deadline](#missed-a-deadline)  
[Introduced a defect](#introduced-a-defect)  Or discuss I noticed a potential issue but didn't fix due to afraid of regression risk. 
   
1. [Customer](#customer)  
Questions: difficult customer  

1. [Earn Trust](#earn-trust):  
[Critial feedback to improve communication](#critical-feedback-to-imrpove-communication)

1. [Learn and be curious](#learn-and-be-curious)  

1. [Ownership](#ownership)
Question: Tell me about a time that you have to make a decision between standard and delivery?
...
### Insist that developers to do thorough testing
   Situation:  
...
### Released fix to production issue although there was risk
...
### Made a functionality work differently to what clients used to
...
### Invent an effective way for database migration
...
I immediately took on the role of her mentor, aiming to provide guidance and help her advance in her career.
   ...
   Action:  
To engage with Geet effectively, I scheduled regular 1:1 meetings with her on a bi-weekly basis. These meetings allowed us to have focused discussions about her career goals, areas of improvement, and any challenges she was facing. During these sessions, we established a clear agenda to ensure we covered specific topics related to her professional development.
