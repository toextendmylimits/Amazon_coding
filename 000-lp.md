...
## Customer
   ...
   Situation:
   When I worked for my previous company, there was once a time that our internal curomer, the business were made upset by my team. One of my team member deployed some changes to a development environment for testing. However, several of our very business people was using that environment to do a demostration of how a new functionality worked to one of our very important clients in a different city. The deployment unexpectedly disrupted the demostration and left a bad impression to the client. As a result, the business people were very frustrated understandbly and complained a lot about my team.
