...
1. Disagree with coding standard  
   ...
   Result:
   Finally these developers agreed with me, changed the code accordingly. And developers from other team were also asked to follow the principles of clean code. A few weeks later, I observed there was significant improvement in the new code from various teams.
