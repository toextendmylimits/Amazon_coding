...
1. Rebuild orderbook application.  
   Questions: Most difficult project you worked on?
    ...
    Result:  
    Eventually the project finished successfully within the scheduled time. Although the code change was tremendous, the system had very few issues since it went live into production. And the new functionalities were well received by the clients and as a result the revenue was incrased by 20%. 
