...
## Customer
   ...
   Situation:
   When I worked for my previous company, there was once a time that our internal curomer, the business were made upset by my team. One of my team member deployed some changes to a development environment for testing. However, several of our very business people was using that environment to do a demostration of how a new functionality worked to one of our very important clients in a different city. The deployment unexpectedly disrupted the demostration and left a bad impression to the client. The business person was very angry understandbly.
   ...
   Result:  
   The business people felt much better and agreed with the new process for managing environments. So I prepared a few dedicated environments for business people and asked both the business people and developers to follow the process. Since then on, the demostration by business people were never disrupte again by unwanted change by developers.
