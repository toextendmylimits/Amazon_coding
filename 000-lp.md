...
## Ownership
   ...
   Situation:
   When I worked for my previous organization, I once noticed the system had issues on a Sunday evening at 7pm. The background was different teams restarted the system on Sundays on a roational basis to make sure the system was in a good state. My team was not on duty that Sunday at all. However, as a habit, I stilled check the chat messages from the work group. Then I noticed the developer who was on duty that Sunday posted a few issues and he was not sure what to do. He asked for help in the wider developers group and there was not response. Likely most of people were still enjoying the weekends.
   ...
   Result:
   As a result, the system was healthy again and ready for Monday's trading. Without my help, these issues would take much longer to be solved, which would  put trenmenous pressure to the developer, his team and the management.
