...
1. Disagree with coding standard  
   ...
   Result:
   Finally these developers agreed with me, changed the code accordingly. And developers from other team were also asked to follow the principles of clean code. Undoubtedly developers needed to spend a little bit more time to make the code cleaner, but overtime, they were used to and it and the code quality was improved significantly.
