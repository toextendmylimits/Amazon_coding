...
1. Tell me about a time that you have to make a decision between standard and delivery?
   ...
   Situation:    
   There was once a time that we had a production issue that a few products' effective dates and termination dates were calculated wrongly by the system. It caused one of our largets clients did wrong trades and which needed to be revoked. The client was very unhappy and asked the company to solve the issue ASAP. As a developer who was very familiar with the system, I was asked to look into the issue and find a fix. I quickly found that these dates were calculated by the system roughly every three months and the core logic was flawed and hence the system could generate wrong dates from time to time. I also tried to understand how the dates were calculated but realized the logic was very complex. Ideally these logic of calcuating dates should be fixed so the issue would not appear again. However, that was not easy and undoubtedly would take much more time as well. 
