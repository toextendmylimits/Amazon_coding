...
## Customer
   ...
   Situation:
   When I worked for my previous company, there was once a time that our internal curomer, the business were made upset by my team. One of my team member deployed some changes to a development environment for testing a feature he worked on. However, several of our very business people were using that environment to do a demostration of how a new functionality worked to one of our very important clients in a different city. The deployment unexpectedly disrupted the demostration and left a bad impression to the client. As a result, the business people were very frustrated understandbly and complained a lot about my team.

   Task:
   So as leader of my team, I needed to calm down the business people and more importantly to find a solution to prevent the issue from happening again
   ...
   Then I made suggestions about how to prevent the issue from happeaning again. I mentioned that given demostration to clients could happen very often, it was better to have dedicated environments for that purpose and no developer should deploy change to these environments until approval from business people. I acknoledged that there were still times that business people needed to use development environments to show some latest functionalities. So I suggested to have a simple internal confluence page listing all the environments we had and which team were responsible maintaining each environment, and events that environments would be used by business people. So when new event was added for business people to use an environment, the relevant development team would receive notifications in email, and would make sure the environment was in a stable state during the event.
   
   Result:  
   The business people felt much better and agreed with my suggestions. So a few dedicated environments were prepared for business people and both the business people and a internal page for managing environments were created and both busienss people and developers from different teams were asked to follow the new process. Since then on, the demostration by business people were never disrupte again by unwanted change from developers.
