...
17. [146. LRU Cache](https://leetcode.com/problems/lru-cache)
18. [1235. Maximum Profit in Job Scheduling](https://leetcode.com/problems/maximum-profit-in-job-scheduling)
19. [238. Product of Array Except Self](https://leetcode.com/problems/product-of-array-except-self)
20. [322. Coin Change](https://leetcode.com/problems/coin-change) 但要输出硬币组合
21. [1244. Design A Leaderboard](https://leetcode.com/problems/design-a-leaderboard)
22. [23. Merge k Sorted Lists](https://leetcode.com/problems/merge-k-sorted-lists)
23. [703. Kth Largest Element in a Stream](https://leetcode.com/problems/kth-largest-element-in-a-stream)
24. Amazon | Onsite | Top 5 recommendations in last hour
...
25. Given a root employee object and two employee IDs, determine if the two employees are Away Team Peers i.e if they have the same level ID but different manager IDs.
26. Find 0 sum subarray
27. Variation of Merge K Sorted Lists
28. [743. Network Delay Time](https://leetcode.com/problems/network-delay-time) Refer https://leetcode.com/discuss/interview-question/4048237/Amazon-or-SDE2-or-Coding-Round-or-Graphs
